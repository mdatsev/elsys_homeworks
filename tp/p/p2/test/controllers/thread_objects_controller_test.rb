...
class ThreadObjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thread_object" do
    assert_difference('ThreadObject.count') do
      post thread_objects_url, params: { thread_object: { thread_id: @thread_object.thread_id, value: @thread_object.value } }
    end
  ...
  test "should update thread_object" do
    patch thread_object_url(@thread_object), params: { thread_object: { thread_id: @thread_object.thread_id, value: @thread_object.value } }
